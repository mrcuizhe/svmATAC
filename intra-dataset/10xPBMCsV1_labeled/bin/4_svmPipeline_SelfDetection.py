...
if enhCutOff == "No":
    if intCutOff == "No":
        run_SVM("../output/10xpbmc5k-snap-full.rds", "../input/pbmc_5k_atac_label_v1.txt", "../tmp/CV_folds.RData", "../output/enhNo_intNo")
else:
    if intCutOff == "No":

        run_SVM("../output/10xpbmc5k-snap-full_enh"+str(enhCutOff)+".rds", "../input/pbmc_5k_atac_label_v1.txt", "../tmp/CV_folds.RData", "../output/enh"+str(enhCutOff)+"_intNo")
    else:
        run_SVM("../output/10xpbmc5k-snap-full_enh"+str(enhCutOff)+"_int"+str(intCutOff)+".rds", "../input/pbmc_5k_atac_label_v1.txt", "../tmp/CV_folds.RData", "../output/enh"+str(enhCutOff)+"_int"+str(intCutOff))
