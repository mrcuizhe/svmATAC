...
if enhCutOff == "No":
    if intCutOff == "No":
        run_SVM("../input/buenrostro2018-snap-full.rds", "../input/metadata_buenrostro2018_sorted.tsv", "../tmp/CV_folds.RData", "../output/enhNo_intNo")
else:
    if intCutOff == "No":
        run_SVM("../output/buenrostro2018-snap-full_enh"+str(enhCutOff)+".rds", "../input/metadata_buenrostro2018_sorted.tsv", "../tmp/CV_folds.RData", "../output/enh"+str(enhCutOff)+"_intNo")
    else:
        run_SVM("../output/buenrostro2018-snap-full_enh"+str(enhCutOff)+"_int"+str(intCutOff)+".rds", "../input/metadata_buenrostro2018_sorted.tsv", "../tmp/CV_folds.RData", "../output/enh"+str(enhCutOff)+"_int"+str(intCutOff))
