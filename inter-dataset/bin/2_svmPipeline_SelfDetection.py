...
# if enhCutOff == "No":
#     if intCutOff == "No":
#         run_SVM("../input/enhNo_intNo/10xpbmc5k-snap-full_v1Train.rds","../input/enhNo_intNo/10xpbmc5k-snap-full_nextgemTest.rds", "../input/pbmc_5k_atac_label_v1.txt","../input/pbmc_5k_atac_label_nextgem.txt", "../tmp/CV_folds_v1Train_nextgemTest.RData", "../output/enhNo_intNo")
# else:
#     if intCutOff == "No":
#         run_SVM("../input/enh"+str(enhCutOff)+"_intNo/10xpbmc5k-snap-full_enh"+str(enhCutOff)+"_v1Train.rds","../input/enh"+str(enhCutOff)+"_intNo/10xpbmc5k-snap-full_enh"+str(enhCutOff)+"_nextgemTest.rds", "../input/pbmc_5k_atac_label_v1.txt","../input/pbmc_5k_atac_label_nextgem.txt", "../tmp/CV_folds_v1Train_nextgemTest.RData", "../output/enh"+str(enhCutOff)+"_intNo")
#     else:
#         run_SVM("../input/enh"+str(enhCutOff)+"_int"+str(intCutOff)+"/10xpbmc5k-snap-full_enh"+str(enhCutOff)+"_int"+str(intCutOff)+"_v1Train.rds","../input/enh"+str(enhCutOff)+"_int"+str(intCutOff)+"/10xpbmc5k-snap-full_enh"+str(enhCutOff)+"_int"+str(intCutOff)+"_nextgemTest.rds", "../input/pbmc_5k_atac_label_v1.txt","../input/pbmc_5k_atac_label_nextgem.txt", "../tmp/CV_folds_v1Train_nextgemTest.RData", "../output/enh"+str(enhCutOff)+"_int"+str(intCutOff))
