...
saveRDS(pbmc.atac.filtered, "./output/pbmc_5k_atac_nextgem.rds")
saveRDS(pbmc.atac.filtered$predicted.id,"./output/pbmc_5k_atac_label_nextgem.rds")
write.table(na.omit(pbmc.atac.filtered$predicted.id),"./output/pbmc_5k_atac_label_nextgem.txt",quote = F,col.names = c("label"),sep="\t")
