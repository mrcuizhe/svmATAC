# cd scripts/
# samtools sort -t CB -@ 20 ../../input/atac_pbmc_5k_v1_possorted_bam.bam > ../../input/atac_pbmc_5k_v1_possorted_bam.sorted.bam
...
df_regions = read.csv("../input/atac_pbmc_5k_v1_peaks.bed",
